...
final class WheelView extends View {
    ...
    public void rotateWheelToTarget(int target) {
        ...
        int DEFAULT_ROTATION_TIME = 9000; //how long it spins
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mWheelItems.size(); i++) {
            ...
            drawText(canvas, tempAngle, sweepAngle, mWheelItems.get(i).name == null ? "" : mWheelItems.get(i).name);
